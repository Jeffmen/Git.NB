...
public abstract class BaseListAdapter extends RecyclerView.Adapter{
	...
	public Object getItem(int position) {
		...
		return list == null ? null : list.get(position-(isShowSearch?1:0));
	}
    ...
    public void update(ArrayList<Object> data){
		isShowLoadMore = true;
    ...
    public void insertAtBack(ArrayList<Object> data){
    	if(data == null || data.size()<PAGE_COUNT){
    		isShowLoadMore = false;
    	}
    	else{
	...
	protected abstract int getTypeNormalViewId();
	...
	public ViewHolder onCreateViewHolder(ViewGroup viewgroup, int viewType) {
		if(viewType == TYPE_FOOTER_VIEW){
			...
			View v = mInflater.inflate(getTypeNormalViewId(),viewgroup,false);
			return new NormalView(v);
		}
	}

	protected abstract void setTypeNormalViewData(ViewHolder vh, int position);
	...
	public void onBindViewHolder(ViewHolder vh, int position) {		
		...
		case TYPE_NORMAL_VIEW:
			setTypeNormalViewData(vh, position);
			break;
	...
	private class NormalView extends EventViewHolder{
